...
import com.example.admin.multithreading.threads.MyAsyncTask;
import com.example.admin.multithreading.threads.MyEventThread;
import com.example.admin.multithreading.threads.MyRunnable;
import com.example.admin.multithreading.threads.MyThread;
...
public class MainActivity extends AppCompatActivity implements Handler.Callback {
    ...
    public void onStartThread(View view) {
        Log.d(MainActivity.class.getSimpleName(), "onStartThread: " + Thread.currentThread());
    ...
    public boolean handleMessage(Message message) {
        Toast.makeText(this,message.getData().getString("data"), Toast.LENGTH_LONG).show();
    ...
    public void onMessageReceived(MyMessageEvent myMessageEvent) {
        Toast.makeText(this,myMessageEvent.getData(),Toast.LENGTH_LONG).show();
    }
